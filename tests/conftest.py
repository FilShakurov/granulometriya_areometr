...
def dfs_itog_test():
    ...
    data2 = {
        ...
        'gran_5-10_%': [0.0],
        'gran_5-2_%': [0.0],
        'gran_2-1_%': [0.0995685363425158],
        'gran_1-0,5_%': [0.13285049833887],
        'gran_0,5-0,25_%': [0.332126245847176],
        'gran_0,25-0,10_%': [0.763890365448505],

        'gran_0.05-0.01_%': [52.6969407079128],
        'gran_0.01-0.002_%': [26.3484703539564],
        'gran_0.002_%': [7.37757169910779],
        'gran_0,10-0,05_%': [12.248581593046],
    }
